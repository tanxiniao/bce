...
class usercontrol extends base {
	...
	function onrectavatar() {
		...
		$this->upload_bos($bigavatarfile,$biginfo,$this->get_avatar($uid,'big',$avatartype));
		$this->upload_bos($middleavatarfile,$middleinfo,$this->get_avatar($uid,'middle',$avatartype));
		$this->upload_bos($smallavatarfile,$smallinfo,$this->get_avatar($uid,'small',$avatartype));
